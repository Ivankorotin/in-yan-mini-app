...
// "Сырая" initData целиком (строка вида "user=...&auth_date=...&hash=...") —
// именно её нужно передавать на сервер для проверки подписи Telegram.
// Возвращает null вне Telegram — тогда серверная проверка невозможна
// и приложение работает на локальных моковых данных без сохранения.
